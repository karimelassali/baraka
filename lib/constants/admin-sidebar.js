...
export const DEFAULT_NAV_CATEGORIES = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'slaughtering', nameKey: 'slaughtering', path: '/admin/slaughtering', icon: Beef, permission: 'manage_inventory', color: 'rose' },
            { id: 'scan', nameKey: 'scan', isStatic: true, path: '/admin/scan', icon: Scan, permission: 'manage_points', color: 'blue' },
        ]
    },
    {
