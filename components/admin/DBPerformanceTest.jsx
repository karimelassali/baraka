...
export default function DBPerformanceTest() {
    ...
    return (
        <div className="p-6 max-w-2xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 my-8">
            ...
            >
                {loading ? 'Running Test...' : 'Run Performance Check'}
            </button>

            {results && (
                <div className="bg-green-50 p-4 rounded-lg border border-green-200 mb-6">
                    <h3 className="font-bold text-green-800 mb-2">Current Result</h3>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="p-3 bg-white rounded shadow-sm">
                            <span className="text-gray-500 block">Analytics</span>
                        ...
                        <div className="p-3 bg-white rounded shadow-sm">
                            <span className="text-gray-500 block">Customers List</span>
                        ...
                        <div className="p-3 bg-white rounded shadow-sm">
                            <span className="text-gray-500 block">Inventory</span>
            ...
            {history.length > 0 && (
                <div>
                    <h3 className="font-bold text-gray-700 mb-3">History (Last 5 Runs)</h3>
