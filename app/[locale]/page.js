        ...
        <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight">
              {t('welcome')} <span className="text-red-600">Baraka</span>
            </h1>
            <motion.p
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-black">{t('phone')}</h4>
                      <a
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-black">{t('email')}</h4>
                      <a
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-black">{t('address')}</h4>
      ...
      <footer className="bg-black text-white pt-16 pb-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="text-lg font-bold mb-4">{t('opening_hours')}</h4>
              <ul className="space-y-2 text-gray-300">
