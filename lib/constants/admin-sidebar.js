...
export const DEFAULT_NAV_CATEGORIES = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'eid', nameKey: 'Eid al Adha', isStatic: true, path: '/admin/eid', icon: ClipboardList, permission: 'manage_eid', color: 'red' },
        ]
    },
    {
        ...
        items: [
            ...
            { id: 'qr_codes', nameKey: 'QR Codes', isStatic: true, path: '/admin/qr-codes', icon: QrCode, permission: 'manage_offers', color: 'indigo' },
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'agent_training', nameKey: 'Agent Training', isStatic: true, path: '/admin/agent-training', icon: Brain, permission: 'manage_agent_training', color: 'red' },
